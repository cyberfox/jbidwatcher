...
public class JFilterField extends JTextField {
  ...
  public JFilterField(String placeholderText, int space) {
    super(space);
  ...
  public JFilterField(int space) {
    this("Search", space);
  }

  public JFilterField(String placeHolder) {
    this(placeHolder, 15);
  }
  ...
  static class CancelBorder extends EmptyBorder {
    ...
    public void paintBorder(Component c, Graphics oldGraphics, int x, int y, int width, int height) {
      JFilterField field = (JFilterField) c;
  ...
  class CancelListener extends MouseInputAdapter {
    private boolean isOverButton(MouseEvent e) {
      ...
      Rectangle innerArea = SwingUtilities.calculateInnerArea(JFilterField.this, null);
