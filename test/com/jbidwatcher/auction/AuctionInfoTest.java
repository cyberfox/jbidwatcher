 ...
 * @version 1.0
 */
public class AuctionInfoTest extends TestCase {
  //TODO: Implement tests...
  public AuctionInfoTest(String name) {
        super(name);
    }
    ...
    public void testSetGetThumbnail() throws Exception {
    }

    public void testSetGetRealContent() throws Exception {
    }

    public void testSetRealContent1() throws Exception {
    }

    public void testSetGetContent() throws Exception {
    }

    public void testSetGetIdentifier() throws Exception {
    }
    ...
    public void testGetShipping() throws Exception {
    }
    ...
    public void testGetSiteThumbnail() throws Exception {
    }

    public void testGetAlternateSiteThumbnail() throws Exception {
    }

    public static Test suite() {
        return new TestSuite(AuctionInfoTest.class);
    }
}
